...
// =============================================================================
// מוודא ששלושת ה-GMAIL_* עובדים ושהמייל (כולל המעטפת הרשמית) מגיע בפועל.
...
import { renderBrandedEmail } from '../services/emailTemplate.js';
